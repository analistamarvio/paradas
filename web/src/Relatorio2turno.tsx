...
/* =============================== Componente =============================== */
export default function RelatorioTurno2() {
  ...
  // <<< FIXO NO 2º TURNO >>>
  const selTurnos = useMemo<Set<string>>(() => new Set(["2"]), []);
  const gTurnos   = useMemo<Set<string>>(() => new Set(["2"]), []);
  const mTurnos   = useMemo<Set<string>>(() => new Set(["2"]), []);
    ...
    <div className="container-fluid py-3">
      <div className="row g-3">
          ...
          <div className="card shadow-sm">
            <div className="card-body">
              <div className="d-flex align-items-center justify-content-between mb-3">
                <h2 className="h3 m-0">Relatório 2º Turno</h2>
              ...
              <div className="row g-3">
                ...
                <div className="col-12 col-md-3">
                  ...
                  <div className="form-control-plaintext fw-bold text-success pt-2">2º turno (fixo)</div>
                </div>
                ...
                <div className="col-12">
                  ...
                  <div className="text-muted small mt-2">
                    Usa <code>/turnos</code> por dia e <code>/eventos</code> para horas paradas (apenas 2º turno).
                  </div>
                </div>
              </div>
          ...
          <div className="card shadow-sm">
            <div className="card-body">
              <h3 className="h5 mb-3">
                Controle de Paradas — Gráfico {gTearName ? `(${gTearName})` : "(1 tear)"} — 2º turno
              </h3>
        ...
        <div className="col-12">
          <div className="card shadow-sm">
            <div className="card-body">
              <h3 className="h5 mb-3">Paradas por Motivo — {mTearName ? `(${mTearName})` : "(1 tear)"} — 2º turno</h3>
