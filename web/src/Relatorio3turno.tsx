...
export default function RelatorioTurno1() {
  ...
  // <<< FIXO NO 3º TURNO >>>
  const selTurnos = useMemo<Set<string>>(() => new Set(["3"]), []);
  const gTurnos   = useMemo<Set<string>>(() => new Set(["3"]), []);
  const mTurnos   = useMemo<Set<string>>(() => new Set(["3"]), []);
            ...
            <div className="card-body">
              ...
              <div className="row g-3">
                ...
                <div className="col-12 col-md-3">
                  ...
                  <div className="form-control-plaintext fw-bold text-success pt-2">3º turno (fixo)</div>
                </div>
